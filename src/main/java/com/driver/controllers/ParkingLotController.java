...
public class ParkingLotController {
    ...
    @GetMapping("/get-allSpots")
    public List<Spot> findAllSpotsOfAParkingLot(@RequestParam  int parkingLotId){
        return parkingLotService.findAllSpotsOfAParkingLot(parkingLotId);
    }
